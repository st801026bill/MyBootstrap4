                    ...
                    <div class="row">
                            <div class="col-4 col-lg-2">
                                    <div id="list-example" class="list-group">
                                            <a class="list-group-item list-group-item-action" href="#item1">1. Bootstrap Input</a>
                                            <a class="list-group-item list-group-item-action" href="#item2">2. Bootstrap Textarea</a>
                                            <a class="list-group-item list-group-item-action" href="#item3">3. Bootstrap Checkboxes</a>
                                            <a class="list-group-item list-group-item-action" href="#item4">4. Inline Checkboxes</a>
                                            <a class="list-group-item list-group-item-action" href="#item5">5. Bootstrap Radio Buttons</a>
                                            <a class="list-group-item list-group-item-action" href="#item6">6. inline radio buttons</a>
                                            <a class="list-group-item list-group-item-action" href="#item7">7. Bootstrap Select List</a>
                                            <a class="list-group-item list-group-item-action" href="#item8">8. Form Control Sizing</a>
                                            <a class="list-group-item list-group-item-action" href="#item9">9. Form Control with Plain Text</a>
                                            <a class="list-group-item list-group-item-action" href="#item10">10. Form Control File and Range</a>
                                    </div>
                            </div>
                            <div class="col-8 col-lg-10">
                                <div data-spy="scroll" data-target="#list-example" data-offset="0" class="scrollspy-example itemArea">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="row">
                                                    <div class="col-sm-12"><h4 class="item" id="item2">2. Bootstrap Textarea</h4></div>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="row">
                                                    <div class="col-sm-12"><h4 class="item" id="item3">3. Bootstrap Checkboxes</h4></div>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="row">
                                                    <div class="col-sm-12"><h4 class="item" id="item4">4. Inline Checkboxes</h4></div>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="row">
                                                    <div class="col-sm-12"><h4 class="item" id="item5">5. Bootstrap Radio Buttonss</h4></div>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="row">
                                                    <div class="col-sm-12"><h4 class="item" id="item6">6. Inline radio buttons</h4></div>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="row">
                                                    <div class="col-sm-12"><h4 class="item" id="item7">7. Bootstrap Select List</h4></div>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="row">
                                                    <div class="col-sm-12"><h4 class="item" id="item8">8. Form Control Sizing</h4></div>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="row">
                                                    <div class="col-sm-12"><h4 class="item" id="item9">9. Form Control with Plain Text</h4></div>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                ...
                                                <form action="/action_page.php">
                                                    ...
                                                    <button ty    pe="submit" class="btn btn-primary">Submit</button>
                                                </form>
                                            </div>
                                        </div>
                                        <br>
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="row">
                                                    <div class="col-sm-12"><h4 class="item" id="item10">10. Form Control File and Range</h4></div>
                                                </div>
                                            </div>
                                            <div class="card-body">
